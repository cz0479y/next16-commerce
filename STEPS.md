...
- Using this client wrapper pattern with a boundary UI helper. Turn on hydration mode, marking my components. Mark as server after refactor, see the donut pattern visual. Notice other boundaries, like client side search, and these server side categories.
